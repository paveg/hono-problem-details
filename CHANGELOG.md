...
- [#135](https://github.com/paveg/hono-problem-details/pull/135) [`a48bfdb`](https://github.com/paveg/hono-problem-details/commit/a48bfdbdd861f7af6864de6c501682468e9ba7dc) Thanks [@paveg](https://github.com/paveg)! - **Breaking** (pre-1.0 minor): `./openapi` integration — `ProblemDetailsSchema` const export is removed and replaced with `getProblemDetailsSchema()`, a memoized factory.
