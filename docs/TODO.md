...
- [x] JSR publish (jsr.json + release workflow + explicit return types for slow types)
...
- [x] Comment on [honojs/middleware #579](https://github.com/honojs/middleware/issues/579)
- [x] Submit third-party listing PR to honojs/website ([honojs/website#827](https://github.com/honojs/website/pull/827))
